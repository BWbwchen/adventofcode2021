...
fn all_board_finish(boards: &mut Vec<bool>, i: usize) -> bool {
    boards[i] = true;
    let mut finish = true;
    for b in boards {
        finish &= *b;
